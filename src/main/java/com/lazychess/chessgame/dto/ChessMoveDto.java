...
public record ChessMoveDto(@Min(value = 0, message = "Number needs to be between 0 and 7")@Max(value = 7, message = "Number needs to be between 0 and 7")int currentRow,
